...
declare module "reflexbox" {
  ...
  export import Box = Reflexbox.Box;
  export import Grid = Reflexbox.Grid;
}
...
declare namespace Reflexbox {
  ...
  interface ReflexProps extends RoboxProps, React.Props<any>, React.HTMLAttributes<HTMLDivElement> {
    flex?: boolean
    //wrap?: boolean
    flexColumn?: boolean
    column?: boolean
